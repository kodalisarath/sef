...
public final class DoesNotStartWithCondition extends Condition {
	private static final long serialVersionUID = -3694168580473926872L;
	// TODO: add logger initialization

	private Pattern startsWithPattern = null;

	public DoesNotStartWithCondition(String pattern) {
		...
		super.setType(ConditionType.DOESNT_START_WITH);
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		DoesNotStartWithCondition other = (DoesNotStartWithCondition) obj;
	...
	public String toString() {
		return " Does Not Start With '" + startsWithPattern + "'";
	}
