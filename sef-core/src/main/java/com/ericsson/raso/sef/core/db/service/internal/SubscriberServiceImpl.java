...
public class SubscriberServiceImpl implements SubscriberService{
	...
	public boolean createSubscriber(String nbCorrelator, Subscriber subscriber)
		...
		if (subscriber.getMsisdn() == null || subscriber.getMsisdn().isEmpty())
			throw new PersistenceError(nbCorrelator,this.getClass().getName(),new ResponseCode(FunctionalDataError,"The 'msisdn' attribute was null and it is PK/CK in 'Subscriber' entity!!"));
	...
	public Subscriber getSubscriber(String nbCorrelator, String msisdn)throws PersistenceError {
		...
		logger.info("DB LATENCY ON READ SUBSCRIBER: " + (endTime - startTime));
		return subscriber;
	}
