...
public final class AddTransform extends Transform {
	private static final long serialVersionUID = 6950315922496713406L;

	// TODO: add logger initialization

	private Number offset = null;

	public AddTransform(Number offset) {
		...
		super.setType(TransformType.ADD);
	...
	public Object apply(Object operand) throws TransformFailedException {
		...
		if (operand instanceof BigInteger) {
			if (this.offset instanceof BigInteger) {
				return ((BigInteger) operand).add((BigInteger) this.offset);
			}

			if (this.offset instanceof BigDecimal) {
				return ((BigDecimal) operand).add((BigDecimal) this.offset);
			} else {
				// TODO:
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		AddTransform other = (AddTransform) obj;
		if (offset == null) {
