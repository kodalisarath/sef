...
public final class DoesNotContainCondition extends Condition {
	private static final long serialVersionUID = 4219747040339221114L;
	// TODO: add logger initialization

	private Pattern pattern = null;

	public DoesNotContainCondition(String pattern) {
		...
		super.setType(ConditionType.DOESNT_CONTAIN);
	...
	public boolean evaluate(Object operand) throws RuleFailedException {
		...
		if (matcher.matches()) {
			...
			// " should not contain the pattern:" + this.pattern);
			return false;
		}
		// TODO: logger.debug("SUCCESS:: Value: " + parameterValue +
		// " does not contain the pattern:" + this.pattern);
		return true;
	}
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		DoesNotContainCondition other = (DoesNotContainCondition) obj;
		if (pattern == null) {
