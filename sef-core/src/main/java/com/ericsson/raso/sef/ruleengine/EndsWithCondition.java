...
public final class EndsWithCondition extends Condition {
	private static final long serialVersionUID = 6714613509997822199L;
	// TODO: add logger initialization

	private Pattern endsWithPattern = null;

	public EndsWithCondition(String pattern) {
		...
		super.setType(ConditionType.ENDS_WITH);
	...
	public boolean evaluate(Object operand) throws RuleFailedException {
		...
		if (!matcher.matches()) {
			...
			// " should end with the pattern:" + this.pattern);
			return false;
		}
		// TODO: logger.debug("SUCCESS:: Value: " + parameterValue +
		// " ends with the pattern:" + this.pattern);
		return true;
	}
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		EndsWithCondition other = (EndsWithCondition) obj;
	...
	public String toString() {
		return " Ends With '" + endsWithPattern + "'";
	}
