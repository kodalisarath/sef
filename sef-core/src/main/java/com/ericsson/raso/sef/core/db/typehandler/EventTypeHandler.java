...
import com.ericsson.raso.sef.core.db.model.EventType;

@MappedTypes(EventType.class)
public class EventTypeHandler extends BaseTypeHandler<EventType> {

    @Override
    public void setNonNullParameter(PreparedStatement preparedStatement, int i, EventType status, JdbcType jdbcType) throws SQLException {
    ...
    public EventType getNullableResult(ResultSet rs, String columnName) throws SQLException {
        ...
        return (name == null) ? null : EventType.valueOf(name);
    }

    @Override
    public EventType getNullableResult(ResultSet rs, int column) throws SQLException {
