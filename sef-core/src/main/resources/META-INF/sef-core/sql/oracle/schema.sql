...
CREATE TABLE ACTOR
(
  NAME  VARCHAR2(50 BYTE) PRIMARY KEY
)
PARTITION BY HASH (NAME) PARTITIONS 32
TABLESPACE TNT_DATA
PCTUSED    0
PCTFREE    30
INITRANS   8
...
(
  ...
  META   VARCHAR2(50 BYTE)    NOT NULL,
  VALUE  VARCHAR2(50 BYTE),  
  CONSTRAINT PK_ACTOR_META PRIMARY KEY (NAME,META),
  CONSTRAINT ACTOR_META_FK FOREIGN KEY (NAME) REFERENCES ACTOR(NAME)
  )
  PARTITION BY HASH (NAME) PARTITIONS 32
TABLESPACE TNT_DATA
PCTUSED    0
...
CREATE TABLE ATOMIC_PRODUCT
(
  SUBSCRIPTION_ID  VARCHAR2(100 BYTE)           NOT NULL,
  NAME             VARCHAR2(100 BYTE)           UNIQUE	NOT NULL,
  "RESOURCE"       VARCHAR2(50 BYTE)            NOT NULL,
  "STATE"            VARCHAR2(10 BYTE)            NOT NULL,
  DEFINED_QOUTA    NUMBER(5),
  CONSUMED_QOUTA   NUMBER(5),
  VALIDITY         VARCHAR2(10 BYTE),
  CONSTRAINT CK_ATOMIC_PRO_STATE CHECK ("STATE" IN('OPEN','CLOSED')),
  CONSTRAINT PK_ATOMIC_PRODUCT PRIMARY KEY (SUBSCRIPTION_ID, NAME)
)
PARTITION BY HASH (SUBSCRIPTION_ID) PARTITIONS 32
TABLESPACE TNT_DATA
PCTUSED    0
PCTFREE    30
INITRANS   8
...
(
  ...
  "STATE"            VARCHAR2(10 BYTE)            NOT NULL,
  CONSTRAINT CK_SUBSCR_HIS_DTATE
  CHECK ("STATE" IN ('IN_ACTIVATION','ACTIVE','IN_RENEWAL','RENEWAL_SUSPENSION','IN_EXPIRY','IN_TERMINATION','CLOSED')),
  CONSTRAINT PK_SUBSCRIPTION_HISTORY PRIMARY KEY (SUBSCRIPTION_ID, EVENT_TIMESTAMP)
  )
  PARTITION BY HASH (SUBSCRIPTION_ID) PARTITIONS 32
  TABLESPACE TNT_DATA
PCTUSED    0
...
(
  ...
  META     VARCHAR2(100 BYTE)                   NOT NULL,
  VALUE    VARCHAR2(50 BYTE),
  CONSTRAINT PK_USER_META  PRIMARY KEY  (USER_ID, META),
  CONSTRAINT FK_USER_META   FOREIGN KEY (USER_ID)   REFERENCES SEF_USER (NAME)
  )
...
(
  ...
  META_KEY      VARCHAR2(100 BYTE)	NOT NULL,
  META_VALUE    VARCHAR2(100 BYTE),
  CONSTRAINT PK_PRODUCT_META  PRIMARY KEY  (PRODUCT_NAME, META_KEY)
)
TABLESPACE TNT_DATA
PCTUSED    0
PCTFREE    30
...
(
  SUBSCRIPTION_ID  VARCHAR2(100 BYTE)           UNIQUE	NOT NULL,
  EVENT_TIMESTAMP  TIMESTAMP(6)                 NOT NULL,
  EVENT_ID         VARCHAR2(10 BYTE)            NOT NULL,
  CHARGED_AMOUNT   NUMBER(20)                   NOT NULL,
  CURRENCY         VARCHAR2(10 BYTE)            NOT NULL,
  CONSTRAINT CK_PURCHASE_HISTORY  CHECK (EVENT_ID IN ('PURCHASE','RENEWAL','TERMINATE')),
  CONSTRAINT PK_PURCHASE_HISTORY  PRIMARY KEY  (SUBSCRIPTION_ID, EVENT_TIMESTAMP)
)
PARTITION BY HASH (SUBSCRIPTION_ID) PARTITIONS 32
TABLESPACE TNT_DATA
PCTUSED    0
...
CREATE TABLE SEF_GROUP
(
  NAME         VARCHAR2(100 BYTE) PRIMARY KEY,
...
CREATE TABLE SEF_USER
(
  NAME      VARCHAR2(100 BYTE)	PRIMARY KEY,
  PASSWORD  VARCHAR2(50 BYTE),
  ACTOR_ID  VARCHAR2(50 BYTE),
  CONSTRAINT SEF_USER_ACTOR   FOREIGN KEY (ACTOR_ID)  REFERENCES ACTOR (NAME)
)
PARTITION BY HASH (NAME) PARTITIONS 32
TABLESPACE TNT_DATA
PCTUSED    0
...
CREATE TABLE GROUP_PRIVILEGE_MAP
(
  GROUP_ID  VARCHAR2(100 BYTE)                  NOT NULL,
  PRIVILEGE_ID  VARCHAR2(100 BYTE)                   NOT NULL,
  CONSTRAINT PK_GROUP_PRIVILEGE_MAP  PRIMARY KEY  (PRIVILEGE_ID, GROUP_ID),
  CONSTRAINT FK_GROUP_PRIVILEGE_PRIVILEGE  FOREIGN KEY (PRIVILEGE_ID)   REFERENCES SEF_PRIVILEGE (NAME),
  CONSTRAINT FK_GROUP_PRIVILEGE_GROUP  FOREIGN KEY (GROUP_ID) REFERENCES SEF_GROUP (NAME)
)
TABLESPACE TNT_DATA
PCTUSED    0
PCTFREE    30
...
(
  USER_ID  VARCHAR2(100 BYTE)                  NOT NULL,
  PRIVILEGE_ID  VARCHAR2(100 BYTE)                   NOT NULL,
  CONSTRAINT PK_USER_PRIVILEGE_MAP  PRIMARY KEY  (PRIVILEGE_ID, USER_ID),
  CONSTRAINT FK_USER_PRIVILEGE_PRIVILEGE  FOREIGN KEY (PRIVILEGE_ID)   REFERENCES SEF_PRIVILEGE (NAME),
  CONSTRAINT FK_USER_PRIVILEGE_USER  FOREIGN KEY (USER_ID) REFERENCES SEF_USER (NAME)
)
TABLESPACE TNT_DATA
PCTUSED    0
PCTFREE    30
...
CREATE TABLE SUBSCRIBER_AUDIT_TRAIL
(
  USER_ID              VARCHAR2(100 BYTE)       NOT NULL,
  EVENT_TIMESTAMP      TIMESTAMP(6)             NOT NULL,
  CHANGE_BY_USER       VARCHAR2(50 BYTE)        NOT NULL,
  ATTRIBUTE_NAME       VARCHAR2(50 BYTE)        NOT NULL,
  ATTRIBUTE_NEW_VALUE  VARCHAR2(4000 BYTE),
  CONSTRAINT PK_SUBSCRIBER_AUDITTRAIL  PRIMARY KEY  (USER_ID, EVENT_TIMESTAMP),
  CONSTRAINT FK_SUBSCRIBER_AUDITTRAIL_SUB   FOREIGN KEY (USER_ID)  REFERENCES SUBSCRIBER (USER_ID)
)
PARTITION BY HASH (USER_ID) PARTITIONS 32
TABLESPACE TNT_DATA
PCTUSED    0
...
(
  GROUP_ID  VARCHAR2(100 BYTE)                  NOT NULL,
  ACTOR_ID  VARCHAR2(50 BYTE)                   NOT NULL,
  CONSTRAINT PK_GROUP_MAP  PRIMARY KEY  (ACTOR_ID, GROUP_ID),
  CONSTRAINT FK_GROUP_MAP_ACTOR_ID  FOREIGN KEY (ACTOR_ID)   REFERENCES ACTOR (NAME),
  CONSTRAINT FK_GROUP_MAP_GROUPID  FOREIGN KEY (GROUP_ID) REFERENCES SEF_GROUP (NAME)
)
TABLESPACE TNT_DATA
PCTUSED    0
PCTFREE    30
