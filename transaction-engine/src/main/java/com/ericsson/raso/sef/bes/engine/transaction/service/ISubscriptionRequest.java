...
public interface ISubscriptionRequest {
	...
	public abstract String purchase(String requestId, String offerId, String subscriberId, Boolean override, Map<String, Object> metas);
	
	public abstract String terminate(String requestId, String subscriptionId, Boolean override, Map<String, Object> metas);
	
	public abstract String expiry(String requestId, String subscriptionId, Boolean override, Map<String, Object> metas);
	
	public abstract String renew(String requestId, String subscriptionId, Boolean override, Map<String, Object> metas);
	
	public abstract String preExpiry(String requestId, String subscriptionId, Boolean override, Map<String, Object> metas);
	
	public abstract String preRenewal(String requestId, String subscriptionId, Boolean override, Map<String, Object> metas);
