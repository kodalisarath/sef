...
public class PreRenewalProcessor implements Processor {

	Logger logger = LoggerFactory.getLogger(PreRenewalProcessor.class);
	...
	public void process(Exchange arg0) throws Exception {
		try {
			...
			logger.debug("Inside Process Method of PreRenewalProcessor ");
			...
			String req = transactionManager.preRenewal(requestId, subscriptionId,
