...
public class PreExpiryProcessor implements Processor {

	Logger logger = LoggerFactory.getLogger(PreExpiryProcessor.class);
	...
	public void process(Exchange arg0) throws Exception {
		try {
			...
			logger.debug("Inside Process Method of PreExpiryProcessor ");
			...
			String req = transactionManager.preExpiry(requestId, subscriptionId,
