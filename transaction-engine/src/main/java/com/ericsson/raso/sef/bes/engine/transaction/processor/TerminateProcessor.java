...
public class TerminateProcessor implements Processor {

	Logger logger = LoggerFactory.getLogger(TerminateProcessor.class);
	...
	public void process(Exchange arg0) throws Exception {
		try {
			...
			logger.debug("Inside Process Method of Terminate Processor ");
			...
			String req = transactionManager.terminate(requestId, subscriptionId,
