...
public class RenewProcessor implements Processor {

	Logger logger = LoggerFactory.getLogger(RenewProcessor.class);
	...
	public void process(Exchange arg0) throws Exception {
		try {
			...
			logger.debug("Inside Process Method of RenewProcessor ");
			...
			String req = transactionManager.renew(requestId, subscriptionId,
