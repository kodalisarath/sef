...
public class BucketRetrieveReadROP implements Processor {
	private static final Logger logger = LoggerFactory.getLogger(BucketCreateOrWriteRop.class);
	@Override
	public void process(Exchange exchange) throws Exception {
		BucketCreateOrWriteRopRequest request = (BucketCreateOrWriteRopRequest) exchange.getIn().getBody();
			...
			metas.add(new com.ericsson.sef.bes.api.entities.Meta("category", request.getCategory()));
			metas.add(new com.ericsson.sef.bes.api.entities.Meta("key", String.valueOf(request.getKey())));
			metas.add(new com.ericsson.sef.bes.api.entities.Meta("bValidFrom", request.getbValidFrom()));
			metas.add(new com.ericsson.sef.bes.api.entities.Meta("bInvalidFrom", request.getbInvalidFrom()));
			metas.add(new com.ericsson.sef.bes.api.entities.Meta("OnPeakAccountID_FU", request.getOnPeakAccountID_FU()));
			metas.add(new com.ericsson.sef.bes.api.entities.Meta("messageId", String.valueOf(request.getMessageId())));
	...
	private SubscriberInfo updateSubscriber(String requestId, String customer_id,List<com.ericsson.sef.bes.api.entities.Meta> metas) throws SmException {
