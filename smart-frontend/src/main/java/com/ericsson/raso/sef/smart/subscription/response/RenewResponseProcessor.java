...
public class RenewResponseProcessor implements Processor {

	private static final Logger logger = LoggerFactory.getLogger(RenewResponseProcessor.class);
	
	@Override
	public void process(Exchange exchange) throws Exception {

		logger.debug("Renew Response arrived!!!");
		...
		String correlationId = (String)objectArray[0];
	 	...
	 	responseHandler.renew(correlationId, fault, result);
	}
