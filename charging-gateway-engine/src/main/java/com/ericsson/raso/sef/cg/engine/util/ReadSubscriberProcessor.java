...
public class ReadSubscriberProcessor implements Processor {
	...
	public void process(Exchange exchange) throws Exception {
		logger.debug("Inside process method of ChargingGateway ReadSubscriberProcessor");
		...
		String correlationId = (String)objectArray[0];
	 	...
	 	logger.debug("Inside ChargingGateway process method of subscriber object is "+subscriber);
	 	SubscriberResponseHandler subscriberResponsehandler=new SubscriberResponseHandler();
	 	logger.debug("Inside ChargingGateway process method of subscriber fault is "+fault +" correlationId is "+correlationId);
