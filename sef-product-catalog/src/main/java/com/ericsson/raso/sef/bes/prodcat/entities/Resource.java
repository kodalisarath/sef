...
public abstract class Resource implements Serializable {
	 ...
	 * 
	 */
	private List<String> fulfillmentProfiles = null;
	...
	public boolean addFulfillmentProfile(String profile) throws CatalogException {
		if (this.fulfillmentProfiles == null)
			this.fulfillmentProfiles = new ArrayList<String>();

		return this.fulfillmentProfiles.add(profile);
	}

	public boolean removeFulfillmentProfile(String profile) {
	...
	public List<String> getFulfillmentProfiles() {
