...
public interface ISubscriptionRequest {
	...
	public @WebMethod abstract String purchase(String requestId, String offerId, String subscriberId, Boolean override, Map<String, String> metas);
	
	public @WebMethod abstract String terminate(String requestId, String subscriptionId, Boolean override, Map<String, String> metas);
	
	public @WebMethod abstract String expiry(String requestId, String subscriptionId, Boolean override, Map<String, String> metas);
	
	public @WebMethod abstract String renew(String requestId, String subscriptionId, Boolean override, Map<String, String> metas);
	
	public @WebMethod abstract String preExpiry(String requestId, String subscriptionId, Boolean override, Map<String, String> metas);
	
	public @WebMethod abstract String preRenewal(String requestId, String subscriptionId, Boolean override, Map<String, String> metas);
