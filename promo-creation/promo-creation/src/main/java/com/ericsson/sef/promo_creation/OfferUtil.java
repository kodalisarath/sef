...
//		lookupResourcesByName.put("BarUpdSubsSeg_Cmd", helper.createUpdateSubscriberSegmentationProfile("BarUpdSubsSeg_Cmd", "Bar Update Subs Segmentation"));
		...
		//TODO Will be enable only after confirmation from Smart.
		//lookupResourcesByName.put("UpdateSubscriberUpdateServiceClass", helper.createUpdateServiceClassProfile("UpdateSubscriberUpdateServiceClass", "Updates SUbscriber Service Class"));		
...
//		offerResources = new ArrayList<Resource>();
//		planCodes = new HashSet<String>();
//		planCodes.add("UpdateSubscriberUpdateServiceClass");
//		offerResources.add(lookupResourcesByName.get("UpdateSubscriberUpdateServiceClass"));
//		offer = helper.createNonCommercialOffer("UpdateSubscriberUpdateServiceClass", "Update Subscriber Update Service Class", planCodes, offerResources);
//		offerManager.createOffer(offer);	
