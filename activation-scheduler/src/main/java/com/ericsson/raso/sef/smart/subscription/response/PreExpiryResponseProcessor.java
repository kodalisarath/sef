...
public class PreExpiryResponseProcessor implements Processor {

	private static final Logger logger = LoggerFactory.getLogger(PreExpiryResponseProcessor.class);
	
	@Override
	public void process(Exchange exchange) throws Exception {

		logger.debug("PreExpiry Response arrived!!!");
		...
		String correlationId = (String)objectArray[0];
	 	...
	 	responseHandler.preExpiry(correlationId, fault, result);
	}
